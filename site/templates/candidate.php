    ...
    <div class="candidate">
      <div class="candidate-left">
        ...
        <div class="candidate-votes">
          ...
          <div class="candidate-votes-text"><span data-vote-count><?= $page->count()->toInt() ?> votes</span></div>
